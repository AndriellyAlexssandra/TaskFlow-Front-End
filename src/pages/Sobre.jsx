    ...
    <div className={styles.pagina}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.listaFuncoes}>
          ...
          <p><strong>Filtrar tarefas:</strong> permite visualizar atividades de acordo com a prioridade.</p>
          <p><strong>Contador de tarefas:</strong> mostra a quantidade de atividades em cada coluna.</p>
          <p><strong>Limpar coluna:</strong> remove todas as tarefas de uma etapa específica.</p>
          <p><strong>Organização visual:</strong> facilita o acompanhamento do progresso das atividades.</p>
        </div>
      </div>
